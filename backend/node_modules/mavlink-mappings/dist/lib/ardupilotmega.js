 ...
 * Set the distance to be repeated on mission resume
 */
class DoSetResumeRepeatDistCommand extends common_1.CommandLong {
 ...
 * Control attached liquid sprayer
 */
class DoSprayerCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Pass instructions onto scripting, a script should be checking for a new command
 */
class DoSendScriptMessageCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Execute auxiliary function
 */
class DoAuxFunctionCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * the control surfaces to prevent them seizing up.
 */
class NavAltitudeWaitCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * A system wide power-off event has been initiated.
 */
class PowerOffInitiatedCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * FLY button has been clicked.
 */
class SoloBtnFlyClickCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * FLY button has been held for 1.5 seconds.
 */
class SoloBtnFlyHoldCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * PAUSE button has been clicked.
 */
class SoloBtnPauseClickCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * and intensity.
 */
class FixedMagCalCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Magnetometer calibration based on fixed expected field values.
 */
class FixedMagCalFieldCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Set EKF sensor source set.
 */
class SetEkfSourceSetCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Initiate a magnetometer calibration.
 */
class DoStartMagCalCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Accept a magnetometer calibration.
 */
class DoAcceptMagCalCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Cancel a running magnetometer calibration.
 */
class DoCancelMagCalCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * vehicle in. When sent to the vehicle says what position the vehicle is in.
 */
class AccelcalVehiclePosCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Reply with the version banner.
 */
class DoSendBannerCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Command autopilot to get into factory test/diagnostic mode.
 */
class SetFactoryTestModeCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Causes the gimbal to reset and boot as if it was just powered on.
 */
class GimbalResetCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Reports progress and success or failure of gimbal axis calibration procedure.
 */
class GimbalAxisCalibrationStatusCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Starts commutation calibration on the gimbal.
 */
class GimbalRequestAxisCalibrationCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Erases gimbal application and parameters.
 */
class GimbalFullResetCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Update the bootloader
 */
class FlashBootloaderCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Reset battery capacity for batteries that accumulate consumed battery via integration.
 */
class BatteryResetCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Issue a trap signal to the autopilot process, presumably to enter the debugger.
 */
class DebugTrapCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Control onboard scripting.
 */
class ScriptingCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Scripting command as NAV command with wait for completion.
 */
class NavScriptTimeCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Maintain an attitude for a specified time.
 */
class NavAttitudeTimeCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * control.)
 */
class GuidedChangeSpeedCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * control.)
 */
class GuidedChangeAltitudeCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * companion-computer command-and-control, not normally operator/GCS control.)
 */
class GuidedChangeHeadingCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
