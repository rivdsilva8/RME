...
(function (MavBatteryFunction) {
     ...
     */
    MavBatteryFunction[MavBatteryFunction["UNKNOWN"] = 0] = "UNKNOWN";
    /**
     * Battery supports all flight systems
     */
    MavBatteryFunction[MavBatteryFunction["ALL"] = 1] = "ALL";
    /**
     * Battery for the propulsion system
     */
    MavBatteryFunction[MavBatteryFunction["PROPULSION"] = 2] = "PROPULSION";
    /**
     * Avionics battery
     */
    MavBatteryFunction[MavBatteryFunction["AVIONICS"] = 3] = "AVIONICS";
    /**
     * Payload battery
     */
    MavBatteryFunction[MavBatteryFunction["PAYLOAD"] = 4] = "PAYLOAD";
 ...
 * other values are floats. This is preferred over COMMAND_LONG when sending positional data in params
 * 5 and 6, as it allows for greater precision when sending latitudes/longitudes. Param 5 and 6 encode
 * positional data as scaled integers, where the scaling depends on the actual command value. NaN or
 * INT32_MAX may be used in float/integer params (respectively) to indicate optional/default values
 * (e.g. to use the component's current latitude, yaw rather than a specific value). The command
 ...
 * sending MAV_CMD commands where param 5 and param 6 contain latitude/longitude data, as sending these
 * in floats can result in a significant loss of precision. COMMAND_LONG is required for commands that
 * mandate float values in params 5 and 6. The command microservice is documented at
...
class DoSetMissionCurrentCommand extends CommandLong {
    ...
    /**
     * Resets mission. 1: true, 0: false. Resets jump counters to initial values and changes mission state
     * "completed" to be "active" or "paused".
     *
     * @min: 0
     * @max: 1
     * @increment: 1
