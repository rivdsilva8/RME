...
class Storm32GimbalManagerInformation extends mavlink_1.MavLinkData {
    constructor() {
        super();
        this.gimbalId = 0;
        this.deviceCapFlags = 0;
        this.managerCapFlags = 0;
        this.rollMin = 0;
        this.rollMax = 0;
        this.pitchMin = 0;
        this.pitchMax = 0;
 ...
 * NaN is to be used to signal unset. A gimbal device is never to react to this command.
 */
class Storm32DoGimbalManagerControlPitchyawCommand extends common_1.CommandLong {
 ...
 * selected profile is reported in the STORM32_GIMBAL_MANAGER_STATUS message.
 */
class Storm32DoGimbalManagerSetupCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
 ...
 * Command to set the shot manager mode.
 */
class QshotDoConfigureCommand extends common_1.CommandLong {
    constructor(targetSystem = 1, targetComponent = 1) {
        super();
