...
IcarousKinematicBands.FIELDS = [
    new mavlink_1.MavLinkPacketField('min1', 0, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('max1', 4, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('min2', 8, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('max2', 12, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('min3', 16, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('max3', 20, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('min4', 24, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('max4', 28, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('min5', 32, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('max5', 36, false, 4, 'float'),
    new mavlink_1.MavLinkPacketField('numBands', 40, false, 1, 'int8_t'),
    new mavlink_1.MavLinkPacketField('type1', 41, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type2', 42, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type3', 43, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type4', 44, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('type5', 45, false, 1, 'uint8_t'),
];
exports.REGISTRY = {
