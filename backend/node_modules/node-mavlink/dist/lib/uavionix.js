...
UavionixAdsbOutCfg.FIELDS = [
    new mavlink_1.MavLinkPacketField('ICAO', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('stallSpeed', 4, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('callsign', 6, false, 1, 'char[]', 9),
    new mavlink_1.MavLinkPacketField('emitterType', 15, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('aircraftSize', 16, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('gpsOffsetLat', 17, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('gpsOffsetLon', 18, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('rfSelect', 19, false, 1, 'uint8_t'),
];
/**
...
UavionixAdsbOutDynamic.FIELDS = [
    new mavlink_1.MavLinkPacketField('utcTime', 0, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('gpsLat', 4, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('gpsLon', 8, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('gpsAlt', 12, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('baroAltMSL', 16, false, 4, 'int32_t'),
    new mavlink_1.MavLinkPacketField('accuracyHor', 20, false, 4, 'uint32_t'),
    new mavlink_1.MavLinkPacketField('accuracyVert', 24, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('accuracyVel', 26, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('velVert', 28, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('velNS', 30, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('VelEW', 32, false, 2, 'int16_t'),
    new mavlink_1.MavLinkPacketField('state', 34, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('squawk', 36, false, 2, 'uint16_t'),
    new mavlink_1.MavLinkPacketField('gpsFix', 38, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('numSats', 39, false, 1, 'uint8_t'),
    new mavlink_1.MavLinkPacketField('emergencyStatus', 40, false, 1, 'uint8_t'),
];
/**
...
UavionixAdsbTransceiverHealthReport.FIELDS = [
    new mavlink_1.MavLinkPacketField('rfHealth', 0, false, 1, 'uint8_t'),
];
exports.REGISTRY = {
